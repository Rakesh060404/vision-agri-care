    ...
    <div className="space-y-6">
      ...
      <Card className="max-w-4xl mx-auto h-[600px] flex flex-col">
        ...
        <CardContent className="flex-1 flex flex-col">
          <ScrollArea className="flex-1 mb-4 pr-4 overflow-y-auto">
            <div className="space-y-4">
              {messages.map((message) => (
                ...
                >
                  ...
                  <div
                    className={`max-w-[80%] p-3 rounded-lg break-words flex-shrink-0 ${message.isBot
              ...
              {isTyping && (
                <div className="flex gap-3 justify-start items-start">
                  ...
                  <div className="bg-secondary text-secondary-foreground p-3 rounded-lg max-w-[80%] flex-shrink-0">
                    <p className="text-sm whitespace-pre-wrap break-words leading-relaxed">AgriVision is typing...</p>
                  </div>
                </div>
              )}
            </div>
