...
export const DiseaseDetection = () => {
  ...
  const mockAnalyze = () => {
    ...
    setTimeout(() => {
      const diseases = [
        { name: "Healthy Plant", confidence: 95, isHealthy: true },
        { name: "Late Blight", confidence: 87, isHealthy: false },
        { name: "Early Blight", confidence: 92, isHealthy: false },
        { name: "Leaf Spot", confidence: 78, isHealthy: false },
        { name: "Powdery Mildew", confidence: 84, isHealthy: false },
      ];
      ...
      toast({
        ...
        description: `Detection completed with ${randomResult.confidence}% confidence`,
      });
    }, 2000);
  };
